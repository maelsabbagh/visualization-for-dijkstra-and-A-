                ...
                for event in pygame_event_list:
                    if event.type == pygame.KEYDOWN:
                        ...
                        if event.key == pygame.K_b:
                            ...
                            graph_shortest_path, maze1 = self.graph.find_shortest_path()
                            ...
                            for i in range(len(graph_shortest_path) - 1):
                                first = graph_shortest_path[i]
                                second = graph_shortest_path[i + 1]
                                for x in ShortestPathBFS.get_shortest_path(maze1, first, second):
                                    self.maze_shortest_path.append(x)
